...
function NotificationsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NotificationsPage.useEffect": ()=>{
            ...
            const refresh = {
                "NotificationsPage.useEffect.refresh": ()=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getNotifications"])(token).then(setItems).catch({
                        "NotificationsPage.useEffect.refresh": ()=>setStatus('Unable to load notifications.')
                    }["NotificationsPage.useEffect.refresh"]);
                }
            }["NotificationsPage.useEffect.refresh"];
            refresh();
            ...
            window.addEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENTS"].notificationsUpdated, refresh);
            return ({
                "NotificationsPage.useEffect": ()=>{
                    disconnect();
                    window.clearInterval(poll);
                    window.removeEventListener(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EVENTS"].notificationsUpdated, refresh);
                }
            })["NotificationsPage.useEffect"];
        }
    }["NotificationsPage.useEffect"], [
    ...
    const handleRead = async (item)=>{
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getToken"])();
        if (!token) return;
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["markNotificationRead"])(token, item.id);
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        !item.read_at && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            className: "btn-ghost",
...
_s(NotificationsPage, "qsR/GIwHW/uk1tB1Lo4ZdBrNdgA=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_0ac0d0d2._.js.map