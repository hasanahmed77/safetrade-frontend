...
function AdminUsersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminUsersPage.useEffect": ()=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminUsers"])(token).then(setUsers).catch({
                "AdminUsersPage.useEffect": ()=>setStatus('Unable to load users.')
            }["AdminUsersPage.useEffect"]);
        }
    }["AdminUsersPage.useEffect"], []);
    const handleRoleChange = async (user, role)=>{
        ...
        if (!token) return;
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateAdminUser"])(token, user.id, role);
    ...
    const handleDelete = async (user)=>{
        ...
        if (!confirmed) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteAdminUser"])(token, user.id);
...
_s(AdminUsersPage, "2MLcI4JSQQD9NT9n0MUVBar3hu0=");
_c = AdminUsersPage;
var _c;
...
//# sourceMappingURL=_6742d6a9._.js.map