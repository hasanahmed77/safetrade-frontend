...
function SellerDashboard() {
    ...
    const [orders, setOrders] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SellerDashboard.useEffect": ()=>{
            ...
            Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSellerProducts"])(token),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSellerOrders"])(token)
            ]).then({
                "SellerDashboard.useEffect": ([productData, orderData])=>{
                    setProducts(productData);
                    setOrders(orderData.length);
                    if (user) {
                        const sellerTotal = orderData.reduce({
                            "SellerDashboard.useEffect.sellerTotal": (sum, order)=>{
                                const itemsTotal = order.items.reduce({
                                    "SellerDashboard.useEffect.sellerTotal.itemsTotal": (itemSum, item)=>{
                                        if (item.product?.seller_id === user.id) {
                                            return itemSum + Number(item.price) * item.quantity;
                                        }
                                        return itemSum;
                                    }
                                }["SellerDashboard.useEffect.sellerTotal.itemsTotal"], 0);
                                return sum + itemsTotal;
                            }
                        }["SellerDashboard.useEffect.sellerTotal"], 0);
                        setBalance(sellerTotal);
                    }
                }
            }["SellerDashboard.useEffect"]).catch({
...
_s(SellerDashboard, "NcILwYREswhjaqV3pBjYzUUjcxQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useAuth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=_5867984e._.js.map